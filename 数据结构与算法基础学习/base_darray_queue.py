...
@Author: 27
@LastEditors: 27
@Date: 2020-03-02 18:24:15
@LastEditTime: 2020-03-07 16:07:16
@FilePath: /Algorithms_Note/数据结构与算法基础学习/base_darray_queue.py
...
class MyQueue(Queue_Interface):
    def __init__(self, capacity = 10):
        self.__data = DynamicArray(capacity)
    def getSize(self):
        return self.__data.getSize()
    def getCapacity(self):
        return self.__data.getCapacity
    def isEmpty(self):
        return self.__data.isEmpty()
    def enqueue(self, e):
        self.__data.addLast(e)
    def dequeue(self):
        self.__data.removeFirst()
    def getFront(self):
