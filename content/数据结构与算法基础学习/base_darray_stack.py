...
@Author: 27
@LastEditors: 27
@Date: 2020-03-02 18:23:57
@LastEditTime: 2020-03-07 15:37:37
@FilePath: /Algorithms_Note/数据结构与算法基础学习/base_darray_stack.py
...
class MyStack(Stack):
    def __init__(self, capacity=10):
        self.__s = DynamicArray(capacity)
    
    def getSize(self):
        return self.__s.getSize()

    def isEmpty(self):
        return self.__s.isEmpty()
    
    def getCapacity(self):
        return self.__s.getCapacity
    
    def push(self, e):
        self.__s.addFirst(e)
    
    def pop(self):
        return self.__s.removeFirst()
    
    def peek(self):
        return self.__s.getFirst()
