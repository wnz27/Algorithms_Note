...
class DynamicArray:
    ...
    def remove(self, index):
        ...
        if self.__size == int(self.capacity / 4) and int(self.capacity / 2) != 0:  # 缩容操作
            self.resize_array(int(self.capacity / 2))
        return res
    ...
    def __str__(self):
        ...
        for i in range(self.__size):
            ...
            if i != self.__size - 1:
                ...
                res += ']'
        return 'dynamic_array: {}, size: {}, capacity: {}'.format(
            res, self.__size, self.capacity)
    ...
    def __repr__(self):
        ...
        return '{}----dynamic_array: {}, size: {}, capacity: {}'.format(
            super_repr, res, self.__size, self.capacity)
