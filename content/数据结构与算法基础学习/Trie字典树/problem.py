...
@Author: 27
@LastEditors: 27
@Date: 2020-05-21 00:11:12
@LastEditTime: 2020-05-21 00:14:40
@FilePath: /Algorithms_Note/content/数据结构与算法基础学习/Trie字典树/problem.py
@description: type some description
'''
'''
问题描述：
请实现一个 Python 方法：输入一组域名，返回一个正则，
使其能判断一个 URL 是否在这些域名下
思路：
正则确实很不熟，但是查了查，正则是回溯，而且如果遇见* ? 
